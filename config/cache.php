...
return [
    ...
    */
    'tags' => [
        'targets' => 'targets_cache_tag',
        'matrix' => 'matrix_cache_tag',
        'users' => 'users_cache_tag',
        'master_data' => 'master_data_cache_tag',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Default time-to-live settings for different cache types
    |
    */
    'ttl' => [
