        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <a href="{{ route('dashboard') }}" class="sidebar-brand">
                    <i class="bi bi-target me-2"></i>{{ __('Target Management') }}
                </a>
                <p class="sidebar-user">{{ Auth::user()->username }}</p>
            </div>
            
            <nav class="sidebar-nav">
                @if(Auth::user()->isAdmin())
                    <div class="nav-section">
                        <div class="nav-section-title">{{ __('Master Data') }}</div>
                        <a class="nav-link {{ request()->routeIs('regions.*') ? 'active' : '' }}" href="{{ route('regions.index') }}">
                            <i class="bi bi-geo-alt"></i>{{ __('Regions') }}
                        </a>
                        <a class="nav-link {{ request()->routeIs('channels.*') ? 'active' : '' }}" href="{{ route('channels.index') }}">
                            <i class="bi bi-diagram-3"></i>{{ __('Channels') }}
                        </a>
                        <a class="nav-link {{ request()->routeIs('suppliers.*') ? 'active' : '' }}" href="{{ route('suppliers.index') }}">
                            <i class="bi bi-building"></i>{{ __('Suppliers') }}
                        </a>
                        <a class="nav-link {{ request()->routeIs('categories.*') ? 'active' : '' }}" href="{{ route('categories.index') }}">
                            <i class="bi bi-tags"></i>{{ __('Categories') }}
                        </a>
                        <a class="nav-link {{ request()->routeIs('salesmen.*') ? 'active' : '' }}" href="{{ route('salesmen.index') }}">
                            <i class="bi bi-people"></i>{{ __('Salesmen') }}
                        </a>
                        <a class="nav-link {{ request()->routeIs('periods.*') ? 'active' : '' }}" href="{{ route('periods.index') }}">
                            <i class="bi bi-calendar"></i>{{ __('Periods') }}
                        </a>
