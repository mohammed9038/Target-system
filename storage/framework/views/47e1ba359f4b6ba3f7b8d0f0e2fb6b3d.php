                    ...
                    <tfoot class="table-light border-top">
                        <tr class="fw-bold">
                            <td colspan="6" class="py-3 px-4 text-end">
                                <i class="bi bi-calculator me-2 text-primary"></i><?php echo e(__('Total Target Amount:')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Target\resources\views/targets/index.blade.php ENDPATH**/ ?>